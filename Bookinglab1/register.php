...
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="register.php" name="register_user">
					<span class="login100-form-title p-b-34">
						Account Registration
					</span>

					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type Your Fullname">
						<input class="input100" type="text" name="fullname" placeholder="Fullname">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type Your Username">
					...
					<div class="wrap-input100 rs2-wrap-input100 validate-input m-b-20" data-validate="Email Doesn't Mastch">
						<input class="input100" type="email" name="email2" placeholder="Confirm Email" >
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 rs2-wrap-input100 validate-input m-b-20" data-validate="Password Doesn't Match">
